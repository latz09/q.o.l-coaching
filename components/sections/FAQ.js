...
const FAQ = ({ data }) => {
	...
	return (
		<SectionContainer fullBleed='bg-gradient-to-b from-sand to-transparent'>
			<div className='px-1.25 lg:px-0.25 grid gap-2 lg:flex lg:gap-4'>
				<h2 className='lg:w-2/5 lg:sticky top-2 self-start'>{heading}</h2>
				<div className='lg:w-3/5 space-y-1.5 lg:space-y-2'>
