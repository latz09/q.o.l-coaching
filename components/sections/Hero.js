	...
	return (
		<SectionContainer className=''>
			<section className='relative w-full  px-0.25 flex items-center justify-center  rounded'>
				...
				{/* Content */}
				<div className='relative z-10 flex flex-col items-center text-center text-white mt-10 lg:mt-[9.5rem] 3xl:mt-[18rem] md:mx-8 lg:mx-10 xl:mx-[18rem]'>
					<svg
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 116 97'
						fill='none'
						className='w-[116px] h-[97px] lg:w-[145px] lg:h-[121px]'
					>
						<path
