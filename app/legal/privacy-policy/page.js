...
// -------------------------------------------
const businessName = 'Quality of Life Coaching, LLC';
const contactEmail = 'QoLCoachingPA@gmail.com';
const effectiveDate = 'March 1, 2026';
const businessLocation = 'United States';
		...
		<section className='flex justify-center py-2 px-1'>
			<article className='max-w-5xl px-1.5 lg:px-md py-sm'>
				...
				<header className='mb-md'>
					<h4>{businessName} – Privacy&nbsp;Policy</h4>
				...
				<section className='mb-sm'>
					...
					<ul className='list-disc list-inside space-y-0.5 mt-0.75 text-paragraph-sm'>
						<li>
							...
							email, phone number, and any details you submit through our
							contact form, booking requests, or other communications.
						</li>
						<li>
							<strong>Coaching &amp; session information.</strong> During
							coaching consultations and Biofield Tuning sessions, you may
							voluntarily share personal details related to your goals,
							well-being, and life circumstances. This information is treated as
							confidential and is used solely to provide and improve your
							coaching experience. We are not a medical provider for purposes of
							these services and this data is not governed by HIPAA.
						</li>
						<li>
						...
						<li>
							...
							our third-party payment provider&nbsp;— we do <em>not</em> store
							full card numbers or payment credentials on our servers.
						</li>
					</ul>
				</section>
				...
				{/* 2. LEGAL BASIS (GDPR) */}
				<section className='mb-sm'>
					<h6>2&nbsp;– Legal Bases for Processing&nbsp;(GDPR)</h6>
				...
				<section className='mb-sm'>
					...
					<ul className='list-disc list-inside space-y-0.5 mt-0.75 text-paragraph-sm'>
						...
						<li>
							Schedule, deliver, and follow up on coaching and Biofield Tuning
							sessions, including sending session summaries.
						</li>
				...
				{/* 4. COOKIES & TRACKING */}
				<section className='mb-sm'>
					<h6>4&nbsp;– Cookies &amp; Similar Technologies</h6>
					<p className='mt-0.75 text-paragraph-sm'>
					...
					<p className='mt-0.75 text-paragraph-sm'>
						<strong>Third-party embeds.</strong> Our site includes embedded
						YouTube videos, which may set their own cookies and collect usage
						data according to{' '}
						<a
				...
				{/* 5. DISCLOSURES */}
				<section className='mb-sm'>
					<h6>5&nbsp;– Sharing of Information</h6>
					<p className='mt-0.75 text-paragraph-sm'>
					...
					<ul className='list-disc list-inside space-y-0.5 mt-0.75 text-paragraph-sm'>
						<li>
							...
							behalf and who are bound by confidentiality obligations. These
							currently include our website hosting provider (Vercel), content
							platform (Sanity), video conferencing platform (Zoom), embedded
							video provider (YouTube/Google), and payment processor.
						</li>
						<li>
				...
				<section className='mb-sm'>
					...
					<p className='mt-0.75 text-paragraph-sm'>
						...
						described above, unless a longer period is required by law. Coaching
						session notes and summaries are retained for the duration of the
						client relationship and deleted upon request thereafter.
					</p>
				</section>

				{/* 7. INTERNATIONAL TRANSFERS */}
				<section className='mb-sm'>
					<h6>7&nbsp;– International Transfers</h6>
					<p className='mt-0.75 text-paragraph-sm'>
				...
				<section className='mb-sm'>
					...
					<p className='mt-0.75 text-paragraph-sm'>
						...
						protect your personal information, including the use of encrypted
						connections (HTTPS) and secure third-party platforms for video
						sessions and payments. However, no method of transmission over the
